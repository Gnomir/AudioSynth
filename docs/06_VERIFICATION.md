...
`tests/stress.rs`) + **23 у плагіні** (analyzer, A/B morph, seed randomiser, preset bank, tuning, Scala import, спектр-гребінка + hover + крива фільтра) + 1 `#[ignore]`
...
### `harmonic_synth` — плагінні (23, `cargo test -p harmonic_synth`)
