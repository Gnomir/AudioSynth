...
| [06_VERIFICATION.md](06_VERIFICATION.md) | Методологія тестування, каталог усіх 105 тестів, виміряні числа, бенчмарки, `pluginval`, крос-верифікація на ARM (bit-exact), що НЕ покрито |
...
105 тестів ядра (87 юніт + 18 інтеграційних) + 25 у плагіні + 1 `#[ignore]`
