...
| [06_VERIFICATION.md](06_VERIFICATION.md) | Методологія тестування, каталог усіх 74 тестів, виміряні числа, бенчмарки, `pluginval`, крос-верифікація на ARM (bit-exact), що НЕ покрито |
...
74 тести проходять (67 юніт + 7 інтеграційних) + 1 `#[ignore]` (дрейф),
