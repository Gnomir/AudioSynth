...
| [06_VERIFICATION.md](06_VERIFICATION.md) | Методологія тестування, каталог усіх 61 тесту, виміряні числа, бенчмарки, `pluginval`, що НЕ покрито |
...
61 тест проходить (57 юніт + 4 інтеграційні) + 1 `#[ignore]` (дрейф) · clippy чистий (stable +
