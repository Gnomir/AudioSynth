...
| [06_VERIFICATION.md](06_VERIFICATION.md) | Методологія тестування, каталог усіх 104 тестів, виміряні числа, бенчмарки, `pluginval`, крос-верифікація на ARM (bit-exact), що НЕ покрито |
...
104 тести ядра (86 юніт + 18 інтеграційних) + 25 у плагіні + 1 `#[ignore]`
