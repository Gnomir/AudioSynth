...
| [21_AUDIT_PLAN_REMAINING_SURFACE.md](21_AUDIT_PLAN_REMAINING_SURFACE.md) | План наступних аудит-раундів на поверхню, яку 8 попередніх раундів НЕ покрили (ДСП-математика вже перевірена до спадної віддачі): C-ABI↔заголовок звірка (✅ зроблено — розбіжностей 0, знайдено й виправлено заглушку `repository` в `Cargo.toml`), GUI/analyzer потоки (✅ зроблено — чисто), Cargo/xtask/vendor-патч і host-lifecycle/persist-межі (заплановано, не виконано) |
