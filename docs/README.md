...
| [06_VERIFICATION.md](06_VERIFICATION.md) | Методологія тестування, каталог усіх 65 тестів, виміряні числа, бенчмарки, `pluginval`, крос-верифікація на ARM (bit-exact), що НЕ покрито |
...
| [15_TECHNICAL_SPEC_HQ_BUS.md](15_TECHNICAL_SPEC_HQ_BUS.md) | RFC-16 Unified HQ Bus: реалізовано. Аліасинг майстра `−94.6` дБ (DoD `−75`) ✅; CPU-DoD `40–50 %` ❌ спростовано вимірюванням (`−0.2 %` — дециматор ніколи не був вузьким місцем). Стандалон `Voice`/C-ABI HQ-шлях лишився недоторканим |
...
65 тестів проходять (60 юніт + 5 інтеграційних) + 1 `#[ignore]` (дрейф),
