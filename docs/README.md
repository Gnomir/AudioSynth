...
| [06_VERIFICATION.md](06_VERIFICATION.md) | Методологія тестування, каталог усіх 76 тестів, виміряні числа, бенчмарки, `pluginval`, крос-верифікація на ARM (bit-exact), що НЕ покрито |
...
76 тестів проходять (69 юніт + 7 інтеграційних) + 1 `#[ignore]` (дрейф),
...
унісон з «диханням» · CC#64 sustain (рівень плагіна) · `panic=abort` в обох
крейтах.
